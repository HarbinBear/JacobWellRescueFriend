...
**已完成**：P1、P3、P4、P7（全部完成，含弹簧臂+摇曳+远近自适应缩放）、P8 第一版完整完成；P2 第一版完成；P5 第一版完成；废弃代码清理完成；迷宫 UI 重设计完成；迷宫食人鱼系统完成；食人鱼死亡过场卡死修复完成；**手动挡转向渐进动画完成（反向输入先掉头再移动，大掉头阶段允许惯性滑行）**
**下一步优先**：
1. NPC 救援反馈（呼救反应 + 绑绳渲染 + 距离约束）
2. P2 角色表现修复（T2.10 roll 滚动、T2.11 腿部脚蹼、T2.12 手电位置）
3. P11 地形序列化系统（T11.1 ~ T11.10）
