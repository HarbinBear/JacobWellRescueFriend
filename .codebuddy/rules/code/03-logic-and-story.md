...
- 使用**高密度洞穴节点网络 + 多层横向连接 + 跨层回环 + 深层诱骗死路 + 轻度粗糙化**的洞穴算法，而不是规则网格迷宫
- 地图主体由大量小中型洞袋和弯折通道组成，并穿插少量**受控的大洞室**，避免全程都处于同一种压抑窄路节奏
- 正确路线会被大量分叉、绕回和假捷径掩盖，很多看似深入很远的通道最终会落到死路
- 回环不是局部点缀，而是贯穿整张图；玩家会频繁遇到重新接回旧区域的洞道
- 空间节奏要求“时而开阔、时而压抑”：既要有绕行窄路，也要有让玩家短暂舒展的大洞室，但不能重新退化成巨大空海
