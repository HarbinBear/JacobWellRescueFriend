    ...
    maze: {
        ...
        sceneThemes: {
            ...
            muddy: {
                ...
                rockShape: 'round',       // 圆润泥团状
                bgDecoType: 'blobShadow',  // 背景：模糊泥团阴影
            },
            // 白石灰岩区：冷白、反光、硬
            limestone: {
                name: '白石灰岩区',
                ...
                rockShape: 'angular',      // 棱角分明方块状
                bgDecoType: 'sharpEdge',   // 背景：远处锐利轮廓
            },
            // 红褐沉底区：锈、淤积、事故感
            rusty: {
                name: '红褐沉底区',
                ...
                rockShape: 'layered',      // 层叠片状沉积岩
                bgDecoType: 'layerLines',  // 背景：水平层叠线
            },
            // 纯白空腔区：空旷、寂静、近乎神圣
            pristine: {
                name: '纯白空腔区',
                ...
                rockShape: 'smooth',       // 光滑圆弧极简
                bgDecoType: 'glowOrb',     // 背景：微弱光球
            },
            // 钟乳石区：尖锐、滴水、锯齿
            stalactite: {
                name: '钟乳石区',
                wallColor: '#2e3028',
                wallHighlight: '#454d3a',
                innerColor: '#1e2218',
                waterTint: 'rgba(60,80,50,0.07)',
                particleDensity: 0.8,
                particleColor: 'rgba(120,140,100,VAR)',
                mapColor: 'rgba(130,150,110,0.55)',
                rockShape: 'spiky',        // 上下尖刺状突起
                bgDecoType: 'stalactites', // 背景：远处尖刺轮廓
            },
            // 大理石区：纹理、冷硬、方正
            marble: {
                name: '大理石区',
                ...
                innerColor: '#252530',
                waterTint: 'rgba(160,165,180,0.06)',
                particleDensity: 0.4,
                particleColor: 'rgba(170,175,190,VAR)',
                mapColor: 'rgba(180,175,195,0.55)',
                rockShape: 'angular',      // 大块方正
                bgDecoType: 'veinLines',   // 背景：纹理线条
            },
            // 黑曜石区：玻璃质、锋利、高反光
            obsidian: {
                name: '黑曜石区',
                wallColor: '#1a1a22',
                wallHighlight: '#2a2a38',
                innerColor: '#101018',
                waterTint: 'rgba(40,30,60,0.08)',
                particleDensity: 0.3,
                particleColor: 'rgba(100,90,130,VAR)',
                mapColor: 'rgba(90,80,120,0.55)',
                rockShape: 'angular',      // 多边形碎片状
                bgDecoType: 'glintSpots',  // 背景：高反光点
            },
            // 砂岩区：颗粒、温暖、粗糙
            sandstone: {
                name: '砂岩区',
                wallColor: '#3d3525',
                wallHighlight: '#50452e',
                innerColor: '#2d2518',
                waterTint: 'rgba(100,80,40,0.07)',
                particleDensity: 1.4,
                particleColor: 'rgba(160,130,80,VAR)',
                mapColor: 'rgba(180,150,90,0.55)',
                rockShape: 'round',        // 圆润但粗糙
                bgDecoType: 'grainDots',   // 背景：颗粒感散点
            },
            // 苔藓岩区：潮湿、生物、绿色附着
            mossy: {
                name: '苔藓岩区',
                wallColor: '#253028',
                wallHighlight: '#354538',
                innerColor: '#1a2218',
                waterTint: 'rgba(40,80,50,0.08)',
                particleDensity: 1.0,
                particleColor: 'rgba(80,130,70,VAR)',
                mapColor: 'rgba(100,150,90,0.55)',
                rockShape: 'round',        // 不规则团状
                bgDecoType: 'mossPatches', // 背景：绿色附着斑块
            },
            // 页岩区：薄片、层叠、水平线
            shale: {
                name: '页岩区',
                ...
                rockShape: 'layered',      // 水平层叠薄片
                bgDecoType: 'layerLines',  // 背景：水平层叠线
            },
        },
        // 全部主题键名（用于每局随机选取子集）
        allThemeKeys: ['muddy', 'limestone', 'rusty', 'pristine', 'stalactite', 'marble', 'obsidian', 'sandstone', 'mossy', 'shale'] as string[],
        // 每局选取的主题数量范围
        themesPerGame: { min: 4, max: 5 },
        // 运行时：当前局选中的主题键名列表（由map.ts生成时填充）
        sceneThemeKeys: [] as string[],
