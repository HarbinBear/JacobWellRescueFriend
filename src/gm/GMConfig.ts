...
export const TABS: GMTab[] = [
    ...
    },
    {
        ...
        items: [
            ...
            { type: 'number', label: '手臂转向摆幅', path: 'diver.armTurnSwing', min: 0, max: 0.6, step: 0.01, precision: 2 },
            ...
            { type: 'number', label: '抬腿回收量', path: 'diver.kickRecoverLength', min: 1, max: 10, step: 0.2, precision: 1 },
            { type: 'number', label: '踢水伸展量', path: 'diver.kickDriveLength', min: 2, max: 12, step: 0.2, precision: 1 },
